...
public static class Inventory
{
  ...
  private static ServerInventory ServerInventory
  {
    get
    {
      return Liquidator.Instance.GameController.IngameState.Data.ServerData.PlayerInventories[0].Inventory;
    }
  }
  ...
  public static Item NextFreeInventoryPositinon
  {
    get
    {
      var inventoryPanel = Liquidator.Instance.GameController.Game.IngameState.IngameUi.InventoryPanel[InventoryIndex.PlayerInventory];
